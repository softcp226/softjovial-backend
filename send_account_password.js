...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Your New Login Details</title>
  <style>
    body {
      margin: 0;
      padding: 0;
...
<body>
  <div class="email-wrapper">
    <div class="email-header">
      <img src="https://softjovial.ltd/css/images/IMG-20220829-WA0004~4.jpg" style="height:100px; width:150px; border-radius:5px" alt="Softjovial Logo" />
      <h2 class="email-title">Your Account Login Details</h2>
    </div>

    <div class="email-body">
      <p>Dear <strong>Anthony Beyda</strong>,</p>

      <p>As requested, we have reset your account credentials. Please use the details below to access your account:</p>

      <div class="credentials">
        <p><strong>Login Link:</strong> <a href="https://softjovial.ltd/vip" target="_blank">https://softjovial.ltd/vip</a></p>
        <p><strong>Email:</strong>anthonybeyda@gmail.com</p>
        <p><strong>Password:</strong> anthony1</p>
      </div>

      <a href="https://softjovial.ltd/vip/login.html" class="cta-button">Login to My Account</a>

      <div class="highlight">
        For your security, please change your password immediately after logging in.
      </div>

      <p>If you encounter any issues accessing your account, kindly contact our support team through your account portal.</p>
    </div>

    <div class="email-footer">
      <p>This message was sent by the Softjovial Security Team.<br>
